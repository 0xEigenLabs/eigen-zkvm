...
const argv = require("yargs")
  .version(version)
  .usage("node simple_vm.js -w /path/to/workspace")
...
const pilFile = path.join(__dirname, "./simple_vm_main.pil");
const proverAddr = "0x2FD31EB1BB3f0Ac8C4feBaF1114F42431c1F29E4";
var start = new Date().getTime()
const pilConfig = {};
const pilCache = "/tmp/simple_vm"
pil_verifier.generate(argv.workspace, pilFile, pilConfig, pilCache, new SimpleVM(), starkStruct, proverAddr, []).then(() => {
