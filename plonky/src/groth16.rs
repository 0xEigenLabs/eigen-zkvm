...
mod tests {
    ...
    const CIRCUIT_FILE: &'static str =
        concat!(env!("CARGO_MANIFEST_DIR"), "/../test/mycircuit.r1cs");
    #[test]
    fn groth16_proof() -> Result<()> {
        ...
        // let verified = Groth16::verify_with_processed_vk(&params.1, &inputs, &proof)?;
