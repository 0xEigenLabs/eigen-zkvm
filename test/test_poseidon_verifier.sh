...
# BN128
#${ZKIT} compile -i ../starkjs/poseidon/circuits/$CIRCOM_FILE.circom -l "../starkjs/node_modules/pil-stark/circuits.bn128" -l "../starkjs/node_modules/circomlib/circuits" --O2=full -o $WORKSPACE
${ZKIT} compile -i ../starkjs/poseidon/circuits/$CIRCOM_FILE.circom -l "../starkjs/node_modules/pil-stark/circuits.gl" -l "../starkjs/node_modules/circomlib/circuits" --O2=full -o $WORKSPACE
