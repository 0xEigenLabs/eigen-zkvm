use crate::ff::*;
use crate::field_gl::Fr as GoldilocksField;
...
const SHIFTED_FIELD_ORDER: __m256i =
    unsafe { transmute([GoldilocksField_ORDER ^ (i64::MIN as u64); 4]) };
fn EPSILON() -> __m256i {
    unsafe {
        let mut a = GoldilocksField::from(18446744069414584620u64);
        let a = a.neg();
        transmute([a; 4])
    }
}
// Goldilocks Order
const GoldilocksField_ORDER: u64 = 0xFFFFFFFF00000001;
...
mod tests {
    ...
    fn test_vals_a() -> [GoldilocksField; 4] {
        [
            GoldilocksField::from(14479013849828404771),
            GoldilocksField::from(9087029921428221768),
            GoldilocksField::from(2441288194761790662),
            GoldilocksField::from(5646033492608483824),
        ]
    }
    fn test_vals_b() -> [GoldilocksField; 4] {
        [
            GoldilocksField::from(17891926589593242302),
            GoldilocksField::from(11009798273260028228),
            GoldilocksField::from(2028722748960791447),
            GoldilocksField::from(7929433601095175579),
        ]
    }
