...
mod tests {
    ...
    #[test]
    fn test_minor() {
        let zero: Fr = Fr::from_str("0").unwrap();
        ...
        let six: Fr = Fr::from_str("6").unwrap();
        let seven: Fr = Fr::from_str("7").unwrap();
        let eight: Fr = Fr::from_str("8").unwrap();
        let nine: Fr = Fr::from_str("9").unwrap();
    ...
    fn test_vec_mul() {
        ...
        let expected: Fr = Fr::from_str("32").unwrap();
